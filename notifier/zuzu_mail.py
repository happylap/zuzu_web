...
class MailSender:
    def __init__(self, user=None, password=None, host='smtp.gmail.com', port='587', encoding="utf-8"):
        self.user = user
        self.host = host
        self.port = port
...
if __name__ == '__main__':
    MailSender('noreply.zuzurentals@gmail.com', 'ji3g4196bj/6gji4').send(['eechih@gmail.com'], '豬豬快租 Test10 - python2.7', '<h1>豬豬快租 Test</h1> test')
